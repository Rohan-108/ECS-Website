    ...
    <>
      <div className="Big_Div">
        ...
        <div className="flex_Container">
          ...
          <div className="smallDiv">
            <div className="card">
              <img className="card-img-top" src={fresher} alt="Card cap"></img>
            </div>
          </div>
          <div className="smallDiv">
            <div className="card">
          ...
          <div className="smallDiv">
            <div className="card">
              <img className="card-img-top" src={dehleez} alt="Card cap"></img>
            </div>
          </div>
          <div className="smallDiv">
            <div className="card">
              <img className="card-img-top" src={dehleez1} alt="Card cap"></img>
            </div>
          </div>
          <div className="smallDiv">
            <div className="card">
              <img className="card-img-top" src={girlDraw} alt="Card cap"></img>
            </div>
          </div>
          <div className="smallDiv">
            <div className="card">
              <img className="card-img-top" src={fresher1} alt="Card cap"></img>
            </div>
          </div>
          <div className="smallDiv">
            <div className="card">
